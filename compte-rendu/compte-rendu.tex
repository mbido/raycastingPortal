...
mais avec des concepts de jeux plus récentes et qui plus est pourrait être
...
Programmer en C++ a pu s'avérer assez technique car cela était un tout nouveau langage de programmation à apprendre pour nous car il n'avait jamais été abordé auparavant lors de notre parcours universitaire.
Une des plus grandes difficultés de ce projet était de développer avec la bibliothèque GF. En effet, quand bien même c'est un bibliothèque possédant un bon nombre de fonctions pouvant permettre le développement graphique 2D, elle reste néanmoins parfois limitée pour les besoins techniques du projet. Mais cela permet de donner des idées de méthodes à ajouter dans GF voire dans GF2.\cite{GF2}
...
Nous avions comme contrainte d'utiliser GF\cite{GF} et donc le langage de programmation C++.
