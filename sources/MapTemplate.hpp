...
{
public:
    MapTemplate(std::string adress = "../sources/map/image9.png")
        : m_image(gf::Image(adress)), m_nbRows(m_image.getSize().width), m_nbColumns(m_image.getSize().height), m_map(new int *[m_nbRows]), m_walls({})
    {
